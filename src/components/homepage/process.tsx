    ...
    return (
        <section className="py-32 bg-bluish">
            <div className="container mx-auto px-4">
                ...
                <div className="flex justify-center items-center gap-8" id="how-it-works">
                    <div className="text-center p-8 pt-6">
                        <div className="w-24 h-24 rounded-full flex items-center justify-center mx-auto mb-6 shadow-lg shadow-blue-100 z-100">
                    ...
                    <div className="text-center p-8 pt-6">
                        <div className="w-24 h-24 rounded-full flex items-center justify-center mx-auto mb-6 shadow-lg shadow-blue-100">
                            <Package className="w-8 h-8 text-yellowish" />
                        </div>
                    ...
                    <div className="text-center p-8 pt-6">
                        <div className="w-24 h-24 rounded-full flex items-center justify-center mx-auto mb-6 shadow-lg shadow-blue-100">
                            <CalendarArrowDown className="w-8 h-8 text-yellowish" />
                        </div>
